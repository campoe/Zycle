...
internal interface IAdapter {
    ...
    fun prepend(@LayoutRes layoutRes: Int): Adapter
    fun prepend(@LayoutRes vararg layouts: Int): Adapter
    fun append(@LayoutRes layoutRes: Int): Adapter
    fun append(@LayoutRes vararg layouts: Int): Adapter
